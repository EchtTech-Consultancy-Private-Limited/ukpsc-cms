               ...
               <div class="small-box bg-warning">
                  <div class="d-flex justify-content-between p-3 align-items-center">
                     <div class="inner">
                        ...
                        <a class="change-credential" href="<?php echo base_url("admin/auth/update_user_info/")?>">
                        New Password
                        </a>
                     </div>
                  ...
                  <a href=" <?php echo base_url("admin/profile/consent_user")?>" class="small-box-footer" style="padding:13px 0;">

      ...
      <div class="card_reg" style="border-color: #373250;">
         ...
         <div class="card-body register-card-body custom-register"
            ...
            <div class="row">
               ...
               <div class="form-group has-feedback col-md-6">
                  <label>
                     Mobile No. (मोबाइल नंबर)<span>*</span> 
                     <span style="font-size:9px;">
                        <!-- (All communication from UKPSC will be sent to this Mobile.) -->
                     </span>
                  </label>
               ...
               <div class="form-group has-feedback col-md-6">
                  <label>
                     Email ID(ईमेल आईडी)<span>*</span> 
                     <span style="font-size:9px;">
                        <!-- (All communication from UKPSC will be sent to this email address.) -->
                     </span>
                  </label>

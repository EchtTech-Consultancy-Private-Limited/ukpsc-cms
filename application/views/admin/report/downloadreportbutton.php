        ...
        <div class="container-fluid">
            ...
            <div class="row mt-4">
                ...
                <div class="col-md-3">
                 ...
                 <!-- 4 -->
                <div class="col-md-3">
                    <div class="card-body report-btn">
                <a href="<?php echo site_url("admin/allocation_admin/generate_pdf/".urlencrypt($id)); ?>" class="btn btn-sec" >Allocation  Report</a>
                </div>
                </div>
            </div>
        </div>

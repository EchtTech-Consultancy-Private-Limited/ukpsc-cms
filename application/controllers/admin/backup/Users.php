...
class Users extends MY_Controller
{
    ...
    public function datatable_json()
    {
        ...
        foreach ($records["data"] as $row) {
            ...
            $data[] = [
                ...
                '<a title="View" class="view btn btn-sm btn-info" href="' .
                base_url("admin/users/edit/" . $row["id"]) .
                ...
                ' title="Delete" onclick="return confirm(\'Do you want to delete ?\')"> <i class="fa fa-trash-o"></i></a>',
            ];
        }
    ...
    public function delete($id = 0)
    {
        ...
        $this->session->set_flashdata(
            "success",
            "Use has been deleted successfully!"
        );

...
class Example extends MY_Controller
{
    ...
    public function datatable_json()
    {
        ...
        foreach ($records["data"] as $row) {
            ...
            $data[] = [
                ...
                '<input type="checkbox" class="tgl-ios" ' .
                $status .
                '><label for=""></label>',
            ];
        }
    ...
    public function pagination()
    {
        ...
        $config = $this->functions->pagination_config(
            $url,
            $count,
            $per_page_record
        );
        ...
        $data["all_users"] = $this->example_model->get_all_users_for_pagination(
            $per_page_record,
            $page
        );
    ...
    function search()
    {
        $this->session->set_userdata(
            "user_search_type",
            $this->input->post("user_search_type")
        );

        $this->session->set_userdata(
            "user_search_from",
            $this->input->post("user_search_from")
        );

        $this->session->set_userdata(
            "user_search_to",
            $this->input->post("user_search_to")
        );
    }
    ...
    public function advance_datatable_json()
    {
        $records[
            "data"
        ] = $this->example_model->get_all_users_by_advance_search();
    ...
    public function charts()
    {
        $data[
            "monthly_users"
        ] = $this->example_model->get_registered_users_by_month();
